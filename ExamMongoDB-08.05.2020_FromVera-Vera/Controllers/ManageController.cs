...
namespace ExamMongoDB.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            var user = await _userManager.GetUserAsync(User);          
            if (model.Fname != user.Fname || model.Lname != user.Lname)
            {
                ...
                {
                    throw new ApplicationException($"Unexpected error occurred setting Firstname or Lastname for user with ID '{user.Id}'.");
                }
